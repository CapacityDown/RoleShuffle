...
1. Tank and Runner multiply Base effective values and convert them to vanilla upgrade levels, capped at HP 4100, sprint speed 205 and stamina 2040. Base and configured minimums are preserved. Lifter sets native Strength to level 200 without additional physics correction; Base Strength 200 excludes it from random assignment. Copied roles and Superbot inherit these targets.
