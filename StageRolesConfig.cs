...
internal sealed class StageRolesConfig
{
    ...
    internal bool RoleIsEnabled(StageRole role) => role switch
    {
        ...
        StageRole.Trickster => TricksterEnabled.Value,
        StageRole.Mechanic => MechanicEnabled.Value,
        StageRole.Electrician => ElectricianEnabled.Value,
        StageRole.Warden => WardenEnabled.Value,
        StageRole.Ninja => NinjaEnabled.Value,
        StageRole.Executioner => ExecutionerEnabled.Value,
        StageRole.Rider => RiderEnabled.Value,
        StageRole.Influencer => InfluencerEnabled.Value,
        StageRole.Werewolf => WerewolfEnabled.Value,
        StageRole.Berserker => BerserkerEnabled.Value,
        StageRole.Bodyguard => BodyguardEnabled.Value,
        StageRole.Rammer => RammerEnabled.Value,
        StageRole.Diver => DiverEnabled.Value,
        StageRole.Sniper => SniperEnabled.Value,
        StageRole.Imitator => ImitatorEnabled.Value,
        StageRole.Avenger => AvengerEnabled.Value,
        StageRole.Brawler => BrawlerEnabled.Value,
        StageRole.Superbot => SuperbotEnabled.Value,
        StageRole.Disaster => DisasterEnabled.Value,
        _ => false
    };
