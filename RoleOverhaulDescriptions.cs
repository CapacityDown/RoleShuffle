...
internal static class RoleOverhaulDescriptions
{
    ...
    internal const string LifterFixed = "Heavy objects are easier to lift and turn.\nHeavy-object grip and rotation stay at {0} times Strength level {1}, regardless of Base upgrades. Light objects use level {1} strength to reduce shaking while held.";
