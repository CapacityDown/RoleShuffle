...
internal static class RoleOverhaulDescriptions
{
    ...
    internal const string LifterFixed = "Heavy objects are easier to lift and turn.\nFor heavy objects, lifting and turning strength are fixed at their highest values across Strength levels 0-{0}, regardless of Base upgrades. Light objects and guns use level {1} handling to reduce shaking while held.";
