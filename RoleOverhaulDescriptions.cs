...
internal static class RoleOverhaulDescriptions
{
    ...
    internal const string LifterFixed = "Sets Strength to level {0}. Vanilla strength penalties still apply. Excluded from random assignment when Base Strength is already level {0}.";
