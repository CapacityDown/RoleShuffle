...
internal static class RoleOverhaulDescriptions
{
    ...
    internal const string LifterGrowth = "Strength target: up to max({0}, Base + {1}), capped at 200. Reduced when vanilla grip penalties would weaken light or heavy objects; stays at Base if no safe gain exists.";
