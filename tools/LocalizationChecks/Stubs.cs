...
internal sealed class StageRolesConfig
{
    ...
    internal Entry<float> JoblessInitialGrace { get; } = new(7.25f);
    internal Entry<float> JoblessTinyGrace { get; } = new(17);
    internal Entry<float> JoblessSmallGrace { get; } = new(17);
    internal Entry<float> JoblessMediumGrace { get; } = new(17);
    internal Entry<float> JoblessBigGrace { get; } = new(17);
    internal Entry<float> JoblessWideGrace { get; } = new(17);
    internal Entry<float> JoblessTallGrace { get; } = new(17);
    internal Entry<float> JoblessVeryTallGrace { get; } = new(17);
    internal Entry<int> JoblessTinyHeal = new(17);
    internal Entry<int> JoblessSmallHeal = new(17);
    internal Entry<int> JoblessMediumHeal = new(17);
    internal Entry<int> JoblessBigHeal = new(17);
    internal Entry<int> JoblessWideHeal = new(17);
    internal Entry<int> JoblessTallHeal = new(17);
    internal Entry<int> JoblessVeryTallHeal = new(17);
