...
translations. The 12 added locales contain every English catalog entry. Japanese role
descriptions remain in `RoleGuideCatalog.cs`; its catalog contains the UI phrases.
