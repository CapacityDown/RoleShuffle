...
internal static class RoleGuideCatalog
{
    ...
    internal static string GenericDescription(StageRole role) =>
        role switch
        {
            ...
            StageRole.Jobless => "Continuously takes damage while outside the truck. This damage can be fatal.",
    ...
    private static string GenericDescriptionJapanese(StageRole role) =>
        role switch
        {
            ...
            StageRole.Jobless => "トラックの外にいる間、継続的にダメージを受けます。このダメージで死亡する可能性があります。",
